...
public class ServletRemoveClassS extends ServletBase {
    ...
    public void doGet(HttpRequest req, HttpResponse res) {// Set response header content
        ...
        contents.append("<title> SeriousEditPage - Remove Class </title>");
        contents.append("</head>");
        ...
        contents.append("<form action=\"RemoveClassS\" method=\"POST\">");

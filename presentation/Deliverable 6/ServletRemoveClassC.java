...
public class ServletRemoveClassC extends HttpServlet {
    ...
    public void doGet(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException {
        ...
        try {
            ...
            out.println("<title> CommonEditPage - Remove </title>");
            out.println("</head>");
            out.println("<body>");
            out.println("<button type=\"submit\" formaction=\"ServletAddClassC\">Add Class</button>");
            out.println("<button type=\"submit\" formaction=\"ServletRemoveClassC\">Remove Class</button>");
            ...
            out.println("<form action=\"RemoveClassC\" method=\"POST\">");

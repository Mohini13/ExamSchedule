...
public class ServletRemoveUserS extends ServletBase {
    ...
    public void doGet(HttpRequest req, HttpResponse res) { // Set response header content
        ...
        contents.append("<title> EditUserPage - Remove </title>");
        contents.append("</head>");
        contents.append("<body>");
        contents.append("<h2>Remove a User:</h2>");
        contents.append("<form action=\"RemoveUser\" method=\"POST\">");
